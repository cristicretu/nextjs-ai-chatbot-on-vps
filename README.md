...
<p align="center">
  An open-source AI chatbot app template built with Next.js, the Vercel AI SDK, OpenAI, and ~~Vercel KV~~ in memory & JSON file cache.
</p>
...
- DOES NOT run on Edge, runs on a €3.30/mo VM on Hetzner in Germany 🇩🇪
